...
class ODESolver(Solver):
    ...
    def sample(
        ...
        Args:
            ...
            extra: Additional input for the model.
        ...
        def ode_func(t, x):
            return self.velocity_model(x=x, t=t, extra=extra)
    ...
    def compute_likelihood(
        ...
        create_hutchinson_graph: bool = False,
        extra: dict = {},
        ...
        def dynamics_func(t, states):
            ...
            with torch.set_grad_enabled(True):
                ...
                if exact_divergence:
                    ...
                    grad_ut_dot_z = gradient(ut_dot_z, xt, create_graph=create_hutchinson_graph)
                    div = torch.einsum(
                        "ij,ij->i",
